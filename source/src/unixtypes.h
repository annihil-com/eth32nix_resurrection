...
#define REMOVE_CG_HOOK(func) \
		if (orig_##func){ \
			Detour.RemoveDetour((void *)((uintptr_t)eth32.cg.module+eth32.cgMod->func), (void *)orig_##func); \
			orig_##func = NULL; \
}

#define CG_HOOK(func) \
		if(eth32.cgMod->func) {\
		orig_##func = (func##_t)Detour.CreateDetour((void *)((uintptr_t)eth32.cg.module+eth32.cgMod->func), (void *)&eth32_##func); \
}
